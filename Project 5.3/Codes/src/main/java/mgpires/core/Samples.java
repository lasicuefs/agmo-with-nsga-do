...
public class Samples {    
    ...
    public void printSelectedSamples () {               
        System.out.println("\nPrinting the selected samples vector. Number of selected samples = " + numberOfSelectedSamples_);
        
        for (int i = 0; i < numberOfTraSamples_; i++) {            
            if (selectedSamples_[i])
                System.out.print("1");                
            else
                System.out.print("0");           
        }
             ...
             BufferedReader leitor = new BufferedReader(reader); )
        {
            ...
            while (line != null) {
                ...
                while (st.hasMoreTokens()) {
                    ...
                    if ((!st.hasMoreTokens()) && (!data.equalsIgnoreCase("@data"))) {
                        line = leitor.readLine();
                    }
                }// end while
            }// end while            
