 ...
 */ 
public class NSGAII_SelectInstances_and_LearningKB_2 implements Callable {
    ...
    public NSGAII_SelectInstances_and_LearningKB_2(String datasetLocation, String databaseName, String configFile, String stratificationDataset, 
        int indexFold, int indexThread, int populationSizeSelectInstances, int maxEvaluationsSelectInstances, double probabilityCrossoverSelectInstances, 
    ...
    public void execute() throws JMException, ClassNotFoundException, IOException {
        ...
        problem = new SelectInstances("ArrayBinarySolutionType", samples, dist);
        */
        double[][] distance;
        ...
        */
        ...
        double timeSelectInstances = aux / 60.0;  // converted in minutes
        ...
        */
        ...
        System.out.println("Fold = " + indexFold + " Training Accuracy = " + accuracyTra + " Test Accuracy = " + 
           ...
           " Time Select Instances = " + timeSelectInstances + " Time LearningKB = " + timeLearningKB); 
...
} // end of NSGAII_SelectInstances_and_LearningKB_2 class